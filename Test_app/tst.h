...
template <class, class = void> struct is_defined_method : std::false_type {};
...
struct is_defined_method<
    ...
    std::enable_if_t<
        ...
        std::is_same<decltype(std::declval<AudioEditor>().importAudio(
                         std::declval<string>())),
                     int>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().exportAudio()),
                     string>::value>> : std::true_type {};

template <class AudioEditor> int tst() {
    if constexpr (is_defined<AudioEditor>::value &&
                  is_defined_method<AudioEditor>::value) {
...
struct is_defined_method<
    ...
    std::enable_if_t<
        ...
        std::is_same<decltype(std::declval<AudioEditor>().importAudio(
                         std::declval<string>())),
                     int>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().exportNotes()),
                     string>::value>> : std::true_type {};
...
struct is_defined_method<
    ...
    std::enable_if_t<
        ...
        std::is_same<decltype(std::declval<AudioEditor>().importAudio(
                         std::declval<string>())),
                     int>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().insertSymbol(
                         std::declval<string>(), std::declval<int>())),
                     void>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().exportAudio()),
                     string>::value>> : std::true_type {};
...
struct is_defined_method<
    ...
    std::enable_if_t<
        ...
        std::is_same<decltype(std::declval<AudioEditor>().importAudio(
                         std::declval<string>())),
                     int>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().deleteSymbol(
                         std::declval<int>())),
                     void>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().exportAudio()),
                     string>::value>> : std::true_type {};
...
struct is_defined_method<
    ...
    std::enable_if_t<
        ...
        std::is_same<decltype(std::declval<AudioEditor>().importAudio(
                         std::declval<string>())),
                     int>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().replaceSymbol(
                         std::declval<string>(), std::declval<int>())),
                     void>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().exportAudio()),
                     string>::value>> : std::true_type {};
...
struct is_defined_method<
    ...
    std::enable_if_t<
        ...
        std::is_same<decltype(std::declval<AudioEditor>().importAudio(
                         std::declval<string>())),
                     int>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().changeOctave(
                         std::declval<int>())),
                     void>::value &&
        std::is_same<decltype(std::declval<AudioEditor>().exportAudio()),
                     string>::value>> : std::true_type {};
